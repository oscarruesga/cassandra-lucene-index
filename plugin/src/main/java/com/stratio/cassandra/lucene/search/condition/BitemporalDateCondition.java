 ...
 */
public class BitemporalDateCondition extends SingleMapperCondition<BitemporalDateMapper> {
     ...
     *
     */
    public BitemporalDateCondition(Float boost,
            String field,
            Object vtFrom,
            Object vtTo,
            Object ttFrom,
            Object ttTo) {
        super(boost, field, BitemporalDateMapper.class);
        this.vtFrom = vtFrom;
        this.vtTo = vtTo;
        this.ttFrom = ttFrom;
        this.ttTo = ttTo;
    ...
    @Override
    public Query query(BitemporalDateMapper mapper, Analyzer analyzer) {
