...
import com.stratio.cassandra.lucene.schema.mapping.BitemporalDateMapper;
import com.stratio.cassandra.lucene.schema.mapping.BitemporalMapper;

/**
 * {@link MapperBuilder} to build a new {@link BitemporalDateMapperBuilder}.
 *
 * @author Eduardo Alonso {@literal <eduardoalonso@stratio.com>}
 */
public class BitemporalDateMapperBuilder extends MapperBuilder<BitemporalDateMapper> {
     ...
     */
    @JsonCreator
    public BitemporalDateMapperBuilder(@JsonProperty("vt_from") String vtFrom,
     ...
     * @return This.
     */
    public BitemporalDateMapperBuilder pattern(String pattern) {
     ...
     * @return This.
     */
    public BitemporalDateMapperBuilder nowValue(Object nowValue) {
     ...
     */
    @Override
    public BitemporalDateMapper build(String field) {
        return new BitemporalDateMapper(field, vtFrom, vtTo, ttFrom, ttTo, pattern, nowValue);
    }
}
